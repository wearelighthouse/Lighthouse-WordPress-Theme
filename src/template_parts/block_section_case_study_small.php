  ...
  <section class="o-container-section o-container-section--h-bordered">
    ...
    <?php if (isset($globalCaseStudyIds) && !empty($globalCaseStudyIds)) : ?>
      ...
      <?php
        ...
        $caseStudyCountainerClass = $caseStudyCount > 2 ? ' o-container-link-blocks--flex' : ' o-container-link-blocks--grid';
      ?>

      <div class="o-container-content o-container-content--v-pad o-container-content--full-width--upto-medium o-container-link-blocks <?= $caseStudyCountainerClass ?>">
