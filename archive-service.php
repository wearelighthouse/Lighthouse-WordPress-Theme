<?php
  ...
  // $introText = getPostMeta('service_archive_front_page_home_intro_text');
?>
   ...
   <?php global $post; ?>
    ...
    <section class="o-container-section o-container-section--h-bordered">
      <div class="o-container-content c-service-mission">
        ...
        <!-- <div class="o-container-content--v-margin c-content-grid"> -->
    ...
    <div class="o-container-content c-service-mission">
      ...
      <div class="c-service-mission__content">
          <?php if ($introText) : ?>
            <p class="c-service-client-testimonial__title c-service-template__title">
              <?= $introText ?>
            </p>
          <?php endif; ?>
          <?php include(locate_template('src/template_parts/service_clients.php')) ?>
    ...
    <?php if ($caseStudyIds) : ?>
      <?php $globalCaseStudyIds = array_slice($caseStudyIds, 0, 1); // 1st 3 case studies ?>
      <?php include(locate_template('src/template_parts/block_section_case_study_large_service.php')) ?>
    <?php endif; ?>

    <!-- <?php if ($caseStudyIds && count($caseStudyIds) > 2) : ?>
      <?php $globalCaseStudyIds = array_slice($caseStudyIds, 2); // the remaining ?>
      <?php include(locate_template('src/template_parts/block_section_case_study_small_service.php')) ?>
    <?php endif; ?> -->
